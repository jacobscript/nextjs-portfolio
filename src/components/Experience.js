        ...
        <div className='my-64'>
            ...
            >
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    ...
                    responsible for developing new features for Google's search
                    engine, including improving the accuracy and relevance of
                    search results and developing new tools for data analysis
                    and visualization."
                    />
                    <Details
                    ...
                    <Details
                        ...
                        work='Worked on a team responsible for designing a new mobile apps that allowed users to create and 
                        share short-form video content, including designing and implementing a new user interface and developing 
                        the backend infrastructure to support the feature.'
                    />
                </ul>
