...
import profilePic from '../../public/images/profile/00001-removebg-preview.png'
...
export default function Home() {
    return (
        <>
            <Head>
                <title>
                    Creative Development Lab | Next.js Tailwind.CSS
                    Framer.Motion
                </title>
                <meta
                    name='description'
                    ...
                    <div className='flex items-center justify-between w-full lg:flex-col'>
                        ...
                        <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
                            <AnimatedText
                                ...
                                className='!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:text:!text-5xl sm:!text-3xl'
                            />
